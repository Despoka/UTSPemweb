...
<head>
  ...
  <!-- ** Basic Page Needs ** -->
  <meta charset="utf-8">
  <title>PPortofolio Badudu - Resume</title>
        ...
        <div class="row">
          <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
            <div class="page-title text-center">
              ...
              <p>These are my Educational History</p>
            </div>
          </div>
        </div> <!-- /.row -->
              ...
              <div class="history-scroller">
                <div class="history-item">
                  ...
                  <div class="history-text">
                    <h5><?php echo ambil_namaInstansi(1) ?></h5>
                    <span><?php echo ambil_jelangPeriode(1)?></span>
                    <p><?php echo ambil_deskripsiPendidikan(1)?></p>
                  </div>
                </div>
                <!-- /.history-item -->
                <div class="history-item">
                  ...
                  <div class="history-text">
                    <h5><?php echo ambil_namaInstansi(2)?></h5>
                    <span><?php echo ambil_jelangPeriode(2)?></span>
                    <p><?php echo ambil_deskripsiPendidikan(2)?></p>
                  </div>
                </div>
              </div>
            </div> <!-- /.history-block -->
            ...
            <div class="history-block">
              ...
              <div class="history-scroller">
                <div class="history-item">
                  ...
                  <div class="history-text">
                    <h5><?php echo ambil_namaPengalaman(1)?></h5>
                    <span><?php echo ambil_jelangPengalaman(1)?></span>
                    <p><?php echo ambil_deskripsiPendidikan(1)?></p>
                  </div>
                </div>
                <!-- /.history-item -->
                <div class="history-item">
                  ...
                  <div class="history-text">
                    <h5><?php echo ambil_namaPengalaman(2)?></h5>
                    <span><?php echo ambil_jelangPengalaman(2)?></span>
                    <p><?php echo ambil_deskripsiPendidikan(2)?></p>
                  </div>
              </div>
            </div> <!-- /.history-block -->
